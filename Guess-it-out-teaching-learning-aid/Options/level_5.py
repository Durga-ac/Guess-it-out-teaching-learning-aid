...
level_5_WORD = ['5+2', '11-3', '22+34', '98-72', '45+20', '28-5', '77+77', '30+99', '46-27', '9-7', '65-20', '7+13',
                '28+8', '232+71', '989-798', '37+11', '790-789', ]

level_5_ANSWER = ['7', '8', '56', '26', '65', '23', '154', '129', '19', '2', '45', '20',
                  '36', '303', '191', '48', '1', ]

ran_num = randrange(0, (len(level_5_WORD)))
jumbled_rand_word = level_5_WORD[ran_num]
...
def main():
    ...
    def change():
        global ran_num
        ran_num = randrange(0, (len(level_5_WORD)))
        word.configure(text=level_5_WORD[ran_num])
    ...
    def cheak():
        ...
        if user_word == level_5_ANSWER[ran_num]:
            points += 5
    ...
    def show_answer():
        ...
        if points > 4:
            ...
            score.configure(text="Score:- " + str(points))
            time.sleep(0.5)
            ans.configure(text="Answer= " + level_5_ANSWER[ran_num])
        else:
